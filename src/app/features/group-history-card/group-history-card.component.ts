...
@Component({
  ...
  template: `
    <p-card [styleClass]="match().status === 'Passando Agora' ? 'h-full border-2 border-green-500/80 shadow-[0_0_15px_rgba(34,197,94,0.15)] relative overflow-hidden transition-all' : 'h-full border-none sm:border-solid !shadow-none sm:!shadow-sm'">
      <ng-template #header>
        ...
        <div class="flex flex-col items-center justify-center w-[20%]">
          @if (match().score?.ft) {
            <div class="flex flex-col items-center gap-1">
              <div class="text-lg bg-surface-800 px-3 py-1 rounded-md">
            ...
            <div class="text-xl text-primary-400">
